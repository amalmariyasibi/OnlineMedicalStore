...
function MedicineForm() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // If editing, fetch medicine data
        if (isEditMode) {
          ...
          if (result.success) {
            ...
            setFormData({
              ...
              manufacturingDate: formatDateForInput(medicine.manufacturingDate),
  ...
  const validateForm = () => {
    if (!formData.name) return "Medicine name is required";
    ...
    if (formData.manufacturingDate && formData.expiryDate) {
      ...
      if (mfgDate > expDate) {
        return "Manufacturing date cannot be after expiry date";
      }
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isEditMode) {
        ...
        result = await updateMedicine(medicineId, medicineData);
      } else {
        // Add new medicine
      ...
      if (result.success) {
        // Redirect to medicine management page
            ...
            <div className="space-y-8 divide-y divide-gray-200">
              ...
              <div className="pt-8">
                <div>
                  ...
                  <p className="mt-1 text-sm text-gray-500">
                    Medicine details and general information.
                  </p>
                </div>
                <div className="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                  ...
                  <div className="sm:col-span-6">
                    ...
                    <p className="mt-2 text-sm text-gray-500">
                      Write a detailed description of the medicine.
                    </p>
                  </div>
                  ...
                  <div className="sm:col-span-6">
                    ...
                    <p className="mt-2 text-sm text-gray-500">
                      Enter a URL for the medicine image.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-8">
                <div>
                  ...
                  <p className="mt-1 text-sm text-gray-500">
                    Detailed medicine specifications and medical information.
                  </p>
                </div>
                <div className="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                  {/* Manufacturer */}
                    ...
                    <div className="flex items-start">
                      ...
                      <div className="ml-3 text-sm">
                        ...
                        <p className="text-gray-500">
                          Check this if a valid prescription is required to purchase this medicine.
                        </p>
                      </div>
                    </div>
                  </div>
            ...
            <div className="pt-5">
              <div className="flex justify-end">
                ...
                <button
                  ...
                  disabled={submitting}
                >
                  {submitting ? "Saving..." : isEditMode ? "Update Medicine" : "Create Medicine"}
                </button>
              </div>
            </div>
          </form>
